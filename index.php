...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
	...
	<li><a href="#buy">Como Comprar?</a></li>
...
<div class="jumbotron">
    <h1>Como Comprar?</h1> 
    <p>Se puede pagar en efectivo en el momento o a traves de transferencia bancaria o pago electronico en <a href="#pricing">productos</a>. Tambien a traves de <a href= "https://listado.mercadolibre.com.ar/_CustId_47227486" target="_new" >mercadolibre</a></p> 
<p>Instalacion sin cargo - Se realizan encomiendas a todo el pais</p>
  </div>
</div>
...
<?php
    $resultado = $connection->query("SELECT * FROM preguntas where pf=1 and activo=1;");
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    ...
    <form action="commentsr.php" method=post>
    <div class="col-sm-7">
      <div class="row">
      ...
      <div class="row">
        <div class="col-sm-12 form-group">
          <button class="btn-lg center-block" role="button" type="submit">Enviar</button>
        </div>
      </div>
<!--  onclick=SendMail() -->
     <!-- <button type="button" class="flash-button bmd-modalButton" data-toggle="modal" data-bmdSrc="https://desolate-cove-81396.herokuapp.com/customer" data-bmdWidth=800 data-bmdHeight="600" data-target="#myModal">Chat con Robot / Operador</button>-->
 </div>
    </div>
     <div class="alert alert-warning">
   <!-- <strong>Atencion! ultimos dias</strong> cerrado por vacaciones del: 25/1 al 15/2. -->
